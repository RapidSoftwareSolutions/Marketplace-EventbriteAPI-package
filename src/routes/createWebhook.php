...
$app->post('/api/EventbriteAPI/createWebhook', function ($request, $response, $args) {
    ...
    if(empty($post_data['args']['endpointUrl'])) {
        $error[] = 'endpointUrl';
    }
    ...
    $body['endpoint_url'] = $post_data['args']['endpointUrl'];
