...
$app->post('/api/EventbriteAPI/getUserOwnedEventAttendees', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'users/'.$post_data['args']['userId'].'/owned_event_attendees/';
