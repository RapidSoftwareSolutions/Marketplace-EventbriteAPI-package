...
$app->post('/api/EventbriteAPI/updateEventPublicDiscount', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'events/'.$post_data['args']['eventId'].'/public_discounts/'.$post_data['args']['discountId'];
